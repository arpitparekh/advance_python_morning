...
button1 = Button(root,command=lambda:myclick("Button 1"),relief=GROOVE,text="Button1",activeforeground="red",activebackground="lightgreen",padx=20,pady=20).pack(side=LEFT)
